...
(function () {
  ...
  style.textContent =
    ...
    .zpw-header { background: ` +
    themeColor +
    `; color: white; padding: 16px; border-radius: 12px 12px 0 0; font-weight: 700; font-size: 16px; text-align: center; }
    ...
    .zpw-item .price { font-size: 14px; font-weight: 700; color: ` +
    themeColor +
    `; }
