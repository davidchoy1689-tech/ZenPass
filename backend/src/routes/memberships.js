...
const MEMBERSHIP_PLANS = {
  lite: {
    ...
    credits_granted: 4,
    duration_days: 30,
    description: "每月 4 Credits，適合輕度運動用戶",
    features: ["每月 4 Credits", "離峰時段只需 1 Credit", "標準取消政策"],
    avg_price: 47,
    popular: false,
  },
  standard: {
    ...
    credits_granted: 10,
    duration_days: 30,
    description: "每月 10 Credits，適合定期運動嘅你",
    features: ["每月 10 Credits", "優先預約權", "離峰時段只需 1 Credit", "寬鬆取消政策"],
    avg_price: 39,
    popular: true,
  },
  silver: {
    ...
    credits_granted: 18,
    duration_days: 30,
    description: "每月 18 Credits，適合運動狂熱者",
    features: ["每月 18 Credits", "VIP 優先預約", "無限取消更換", "每月 1 堂私人教練"],
    avg_price: 33,
    popular: false,
  },
  gold: {
    ...
    credits_granted: 30,
    duration_days: 30,
    description: "每月 30 Credits + 無限堂數，終極運動體驗",
    features: ["每月 30 Credits", "無限堂數選項", "白金優先預約", "無限取消更換", "每月 2 堂私人教練", "專屬客服"],
    avg_price: 0,
    popular: false,
  },
};
