...
const MEMBERSHIP_PLANS = {
  lite: {
    ...
    features: ["每月 4 Credits", "優先預約權", "標準取消政策"],
    avg_price: 62,
    popular: false,
  },
  standard: {
    ...
    features: ["每月 10 Credits", "優先預約權", "高峰扣 3 Credit", "寬鬆取消政策"],
    avg_price: 50,
    popular: true,
  },
  silver: {
  ...
  gold: {
    ...
    credits_granted: 30,
    duration_days: 30,
    description: "每月 30 Credits，終極運動體驗",
    features: ["每月 30 Credits", "白金優先預約", "無限取消更換", "每月 2 堂私人教練", "專屬客服"],
    avg_price: 40,
    popular: false,
  },
};
