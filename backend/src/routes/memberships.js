...
const MEMBERSHIP_PLANS = {
  lite: {
    ...
    credits_granted: 25,
    duration_days: 30,
    description: "每月 25 Credits，適合輕度運動用戶",
    features: ["每月 25 Credits", "優先預約權", "自由取消（適用於開課前一日）"],
    avg_price: 12,
    popular: false,
  },
  standard: {
    ...
    credits_granted: 62,
    duration_days: 30,
    description: "每月 62 Credits，適合定期運動嘅你",
    features: ["每月 62 Credits", "優先預約權", "高峰有 premium", "自由取消（適用於開課前一日）"],
    avg_price: 8,
    popular: true,
  },
  silver: {
    ...
    credits_granted: 111,
    duration_days: 30,
    description: "每月 111 Credits，適合運動狂熱者",
    features: ["每月 111 Credits", "VIP 優先預約", "無限取消更換", "每月 1 堂私人教練", "自由取消（適用於開課前一日）"],
    avg_price: 8,
    popular: false,
  },
  gold: {
    ...
    credits_granted: 186,
    duration_days: 30,
    description: "每月 186 Credits，終極運動體驗",
    features: ["每月 186 Credits", "白金優先預約", "無限取消更換", "每月 2 堂私人教練", "專屬客服", "自由取消（適用於開課前一日）"],
    avg_price: 8,
    popular: false,
  },
};
