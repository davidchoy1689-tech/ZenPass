...
const MEMBERSHIP_PLANS = {
  lite: {
    ...
    features: ["每月 25 Credits", "優先預約權", "標準取消政策"],
    avg_price: 8,
    popular: false,
  },
  standard: {
    ...
    features: ["每月 62 Credits", "優先預約權", "高峰有 premium", "寬鬆取消政策"],
    avg_price: 8,
    popular: true,
  },
  silver: {
    ...
    features: ["每月 111 Credits", "VIP 優先預約", "無限取消更換", "每月 1 堂私人教練"],
    avg_price: 8,
    popular: false,
  },
  gold: {
    ...
    features: ["每月 186 Credits", "白金優先預約", "無限取消更換", "每月 2 堂私人教練", "專屬客服"],
    avg_price: 8,
    popular: false,
  },
};
