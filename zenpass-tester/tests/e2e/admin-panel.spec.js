...
test.describe('Booking Flow', () => {
  ...
  test('courses page has filter buttons', async ({ page }) => {
    ...
    await page.waitForLoadState('networkidle');
    const buttons = page.locator('button, .category-btn, .filter-btn, .nav-item');
  ...
  test('login page has form inputs', async ({ page }) => {
    ...
    await page.waitForLoadState('networkidle');
    const inputs = page.locator('input[type="email"], input[name="email"], input[type="password"], input[name="password"]');
